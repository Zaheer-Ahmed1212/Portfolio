...
function Abtpage() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      sections.forEach((section) => {
        ...
        const items = section.querySelectorAll('.about-item')
  ...
  return (
    <div ref={pageRef} className='text-white pt-30'>
      <section className='about-section px-5 sm:px-8 lg:px-12 py-20'>
        <div className='max-w-6xl mx-auto'>
          <p className='about-label text-blue-400 text-sm sm:text-base font-medium tracking-wider'>
            ABOUT ME
          </p>

          <h1 className='about-heading text-4xl sm:text-5xl lg:text-6xl font-bold mt-2 tracking-tight'>
            Get To Know{' '}
          ...
          <p className='about-description text-zinc-400 text-sm sm:text-base lg:text-lg max-w-2xl mt-5 leading-relaxed'>
      ...
      <section className='about-section px-5 sm:px-8 lg:px-12 pb-20'>
        <div className='max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center'>
          <div>
            <p className='about-label text-blue-400 text-sm font-medium tracking-wider'>
              WHO I AM
            </p>

            <h2 className='about-heading text-3xl sm:text-4xl font-bold mt-2 tracking-tight'>
              Turning Ideas Into{' '}
              <span className='text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-cyan-300'>
                Web Experiences
              </span>
            ...
            <p className='about-description text-zinc-400 mt-5 leading-relaxed'>
            ...
            <p className='about-description text-zinc-400 mt-4 leading-relaxed'>
          ...
          <div className='about-card border border-zinc-800 rounded-2xl p-6 sm:p-8 bg-zinc-950/50 backdrop-blur-sm shadow-xl shadow-black/10 hover:border-blue-500/40 transition duration-300'>
      ...
      <section className='about-section px-5 sm:px-8 lg:px-12 py-20'>
        <div className='max-w-6xl mx-auto'>
          ...
          <h2 className='about-heading text-3xl sm:text-4xl lg:text-5xl font-bold mt-2 tracking-tight'>
            How I{' '}
            <span className='text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-cyan-300'>
              Work
            </span>
          ...
          <div className='mt-10 border-l border-zinc-800 ml-2 pl-6 sm:pl-8 space-y-10'>
            <div className='about-item relative group'>
        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mt-10'>
            {[
              ...
              <div
                key={technology}
                className='about-card group border border-zinc-800 bg-zinc-950/50 backdrop-blur-sm rounded-xl p-5 text-center hover:border-blue-500/50 hover:bg-blue-500/5 hover:-translate-y-1 shadow-lg shadow-black/10 transition duration-300'
              >
      ...
      <section className='about-section px-5 sm:px-8 lg:px-12 py-20'>
        <div className='about-card max-w-5xl mx-auto border border-zinc-800 bg-zinc-950/50 backdrop-blur-sm rounded-2xl p-8 sm:p-12 text-center shadow-2xl shadow-black/20 hover:border-blue-500/30 transition duration-300'>
          <p className='about-label text-blue-400 text-sm sm:text-base font-medium tracking-wider'>
            LET'S CONNECT
          </p>

          <h2 className='about-heading text-3xl sm:text-4xl lg:text-5xl font-bold mt-3 tracking-tight'>
          ...
          <p className='about-description text-zinc-400 max-w-2xl mx-auto mt-5 leading-relaxed'>
          ...
          <Link
            to='/contact'
            className='about-button inline-flex items-center mt-7 px-6 py-2.5 bg-blue-500 hover:bg-blue-400 hover:-translate-y-0.5 rounded-lg shadow-lg shadow-blue-500/20 transition duration-300'
          >
            Start a Project
          </Link>
        </div>
