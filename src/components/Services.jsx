...
description:
'Professional websites that adapt seamlessly to mobile, tablet, and desktop, giving your visitors a consistent experience on every screen.'
},
{
icon: <FaCode />,
title: 'Landing Pages',
description:
'High-quality landing pages designed to showcase your business, product, or service and create a strong first impression online.'
},
{
icon: <FaReact />,
title: 'React Applications',
description:
'Fast, interactive, and scalable web applications built with React and modern frontend technologies to deliver smooth user experiences.'
},
{
icon: <FaMobileScreen />,
title: 'Website Redesign',
description:
'Transform outdated websites into modern, responsive, and user-friendly experiences with cleaner layouts and improved visual appeal.'
}
]

return ( <section className='text-white px-5 sm:px-8 lg:px-12 py-20'> <div className='max-w-6xl mx-auto'> <div className='mb-10'> <p className='text-blue-400 text-sm sm:text-base font-medium tracking-wider'>
SERVICES </p>
